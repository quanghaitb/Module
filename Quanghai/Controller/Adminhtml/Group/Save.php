...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Module\Quanghai\Model\Group')->load($id);
            if (!$model->getId() && $id) {
    ...
    {
        return $this->_authorization->isAllowed('Module_Quanghai::group_update') || $this->_authorization->isAllowed('Module_Quanghai::group_create');
    }
}
